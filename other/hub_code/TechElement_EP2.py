...
DEVICE_MESSAGE_MAP = {  # B = u8, b = i8, H = u16, h = i16, i = i32
    ...
    0x0C: ("Color",        "<BBBHHHHHBBB",  ['color', 'reflection', 'red', 'green', 'blue', 'clear', 'infraread', 'hue', 'saturation', 'value']),
    0x0D: ("Joystick",     "<Bbbhh",        ['leftStep', 'rightStep','leftAngle','rightAngle']),
    0x10: ("imu gesture",  "<BB",           None),
    0x11: ("motor gesture","<BB",           None),
}
